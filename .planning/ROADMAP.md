...
- 📋 **v1.2** — not yet scoped (`/gsd-new-milestone`)
...
### 📋 v1.2 (Planned — not yet scoped)

Run `/gsd-new-milestone` to scope v1.2. Carried-forward candidates:

- [ ] Resume the parked 24/7 live deploy on an always-on residential host (closes DEPLOY-02/03/05/08 + the live-UAT tail)
- [ ] RAG long-term semantic memory (pgvector + Gemini embeddings) for callback roasts
- [ ] Vision / multimodal roasting (Dexter reacts to images in chat)
