...
MEMORY_SIMILARITY_FLOOR = 0.70                  # tuned via 11-02 spike 2026-06-29 (high-precision floor; relevant 0.58–0.77, decoys 0.53–0.66 — no clean global sep, keep tight)
MEMORY_DEDUP_THRESHOLD = 0.92                   # tuned via 11-02 spike 2026-06-29 (raised from 0.90; near-dup pairs scored 0.937/0.955, distinct facts max 0.79)
