...
VALID = [{"title": "Blinding Lights", "artist": "The Weeknd"}, {"title": "Tadow", "artist": "Masego"}]


class TestParseSuggestions:
    def test_clean_array(self):
        assert (
            parse_suggestions('[{"title":"Blinding Lights","artist":"The Weeknd"},{"title":"Tadow","artist":"Masego"}]')
            == VALID
        )

    def test_json_fenced(self):
        text = '```json\n[{"title":"Blinding Lights","artist":"The Weeknd"},{"title":"Tadow","artist":"Masego"}]\n```'
    ...
    def test_trailing_prose_and_whitespace(self):
        text = '[{"title":"Blinding Lights","artist":"The Weeknd"},{"title":"Tadow","artist":"Masego"}]\n\nEnjoy!  '
        assert parse_suggestions(text) == VALID

    def test_object_wrapped_array(self):
        text = '{"songs": [{"title":"Blinding Lights","artist":"The Weeknd"},{"title":"Tadow","artist":"Masego"}]}'
        assert parse_suggestions(text) == VALID
